...
const signUp = () => {
  return (
    ...
    <View className="w-full h-full bg-white">
      ...
      <Text className="font-pbold text-2xl mt-5 text-center ">Create account</Text>
      <Text className="font-pregular text-center">Sign up new account</Text>
      <View className="flex-row justify-center gap-5 mt-1">
        <TouchableOpacity className=" w-[145px] h-[118px] bg-[#D9D9D9] hover:bg-[#afa2a2] items-center justify-center"
         activeOpacity={0.5}
         >
          <Image
          source={icons.admin}
      ...
      <TouchableOpacity
          ...
          <Text className="font-pregular text-lg text-center">Register</Text>
          </TouchableOpacity>
          </View>
          ...
          <View className=" flex-row justify-center items-center pt-5">
            ...
            <Link href="/login"><Text className="font-pregular text-primary">Login here</Text></Link>
          </View>
