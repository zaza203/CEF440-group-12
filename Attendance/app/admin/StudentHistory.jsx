...
//   const totalSessions = studentData.attendance.length;
//   const attendedSessions = studentData.attendance.filter(record => record.status === 'Present').length;
...
//         <Text style={styles.course}>Course: {studentData.course}</Text>
//       </View>
//       <View style={styles.summary}>
//         <Text style={styles.summaryText}>Total Sessions: {totalSessions}</Text>
//         <Text style={styles.summaryText}>Attended: {attendedSessions}</Text>
//         <Text style={styles.summaryText}>Attendance: {attendancePercentage.toFixed(2)}%</Text>
//       </View>
//       <FlatList
